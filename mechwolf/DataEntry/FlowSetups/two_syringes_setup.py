"""
Two Syringes, 1 Reaction Coil, 1 Mixer Setup

This module provides the specific implementation for a two-syringe flow setup
...
class TwoSyringesComponentApp(BaseComponentApp):
    """Component app for two syringes setup"""
    ...
    def _gather_inputs(self) -> None:
        """Gather inputs specific to two syringes setup"""
    ...
    def _create_apparatus_config(self) -> Dict[str, Any]:
        """Create apparatus config for two syringes setup"""
        config = {

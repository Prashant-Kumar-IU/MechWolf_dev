...
class ComponentApp:
    ...
    def fill_vessel_details(self):
        fields = {
            ...
            "vessel_3_name": "Enter the name for vessel 3:",
            "vessel_3_description": "Enter the description for vessel 3:",
        ...
        self.vessel_3_description = dialog.result["vessel_3_description"]
        self.vessel_3_name = dialog.result["vessel_3_name"]
    ...
    def fill_tubing_details(self):
        ...
        if None in [self.thin_tube_ID, self.thin_tube_OD] or (self.using_mixer and None in [self.thick_tube_ID, self.thick_tube_OD]):
    ...
    def fill_coil_lengths(self):
        fields = {
            ...
            "coil_b_length": "Enter the length of coil B (e.g., '5 foot'):",
            "coil_y_length": "Enter the length of coil Y (e.g., '5 foot'):"
        }
        ...
        self.coil_b_length = parse_and_validate(dialog.result["coil_b_length"])
        self.coil_y_length = parse_and_validate(dialog.result["coil_y_length"])

        if None in [self.coil_a_length, self.coil_x_length, self.coil_b_length, self.coil_y_length]:
        ...
        self.add_elements_to_listbox([
            ...
            f"Coil B: {self.coil_b_length}",
            f"Coil Y: {self.coil_y_length}"
        ])
    ...
    def create_setup(self):
        ...
        vessel_3 = mw.Vessel(self.vessel_3_description, name=self.vessel_3_name)
        ...
        coil_b = thin_tube(length=self.coil_b_length)
        coil_y = thin_tube(length=self.coil_y_length)

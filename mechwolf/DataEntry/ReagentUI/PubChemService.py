...
from mechwolf.DataEntry.ReagentUI.ReagentUtils import (
            ...
            if "Record" in data and "Section" in data["Record"]:
                for section in data["Record"]["Section"]:
                    if (
                        ...
                        and section["TOCHeading"] == "Chemical and Physical Properties"
                    ):
                        if "Section" in section:
                            for subsection in section["Section"]:
                                if (
                                    "TOCHeading" in subsection
                                    and subsection["TOCHeading"]
                                    == "Experimental Properties"
                                ):
                                    if "Section" in subsection:
                                        for prop_section in subsection["Section"]:
                                            if (
                                                "TOCHeading" in prop_section
                                                and prop_section["TOCHeading"]
                                                == "Density"
                                            ):
                                                if "Information" in prop_section:
                                                    for info in prop_section[
                                                        "Information"
                                                    ]:

...
class StructureVisualizer:
    ...
    def _render_structure(
        smiles: str, size: Tuple[int, int] = (150, 150)
    ) -> Optional[Any]:
        """
    ...
    def get_structure_image(
        ...
        return widgets.Image(
            value=buffer.getvalue(), format="png", width=size[0], height=size[1]
        )

    @staticmethod
    def get_structure_output(
        smiles: str, size: Tuple[int, int] = (180, 180)
    ) -> widgets.Output:
        """

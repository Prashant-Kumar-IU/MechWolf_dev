...
try:
    from .reagent_utils import validate_smiles, suppress_stderr, safe_mol_from_smiles
except ImportError:
    try:
        from mechwolf.DataEntry.Phase1_ReagentEntry.reagent_utils import validate_smiles, suppress_stderr, safe_mol_from_smiles
    except ImportError:
        # Fallback implementations if reagent_utils is not available

...
from ..utils.imports import get_reagent_utils, suppress_stderr

# Get utility functions through centralized import handler
_utils = get_reagent_utils()
validate_smiles = _utils['validate_smiles']
...
class PubChemService:
    ...
    def get_compound_by_name(self, name: str) -> Optional[Dict[str, Any]]:
        """
        Get compound data by name - compatibility method for old interface
